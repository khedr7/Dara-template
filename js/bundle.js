        ...
        <div class="col-xl-3 col-lg-6 col-md-6 te-footer-widget-wrapper">
          <div class="te-footer-widget">
            <div class="te-footer-widget-info">
              ...
              <p style="font-size: 14px; opacity: 0.8">A leading Syrian company in real estate development, contracting, tourism, and consultancy.</p>
            </div>
            <div class="te-social-profile">
              <a href="#"><i class="fa-brands fa-facebook-f"></i></a>
              <a href="#"><i class="fa-brands fa-instagram"></i></a>
              ...
              <div class="footer-contact">
                <ul>
                  <li>
                    ...
                    <div class="contact-text"><a href="tel:+963-XXX-XXXX">+963-XXX-XXXX</a></div>
                  </li>
                  <li>
                    <div class="contact-icon"><i class="fa-solid fa-envelope"></i></div>
                    <div class="contact-text"><a href="mailto:info@daragroup.com"><span>info@daragroup.com</span></a></div>
                  </li>
                  <li>
                    <div class="contact-icon"><i class="fa-solid fa-location-dot"></i></div>
                    <div class="contact-text"><span>Damascus, Syria<br />دمشق، سوريا</span></div>
                  </li>
                </ul>
              </div>
            </div>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 te-footer-widget-wrapper">
          <div class="te-footer-widget">
            ...
            <div class="te_widget_latest_post">
              <ul>
                <li>
                  <div class="te-latest-post-thumb"><a href="gallery.html"><img src="images/blog/r1.jpg" alt="Bait Al Robyan" /></a></div>
                  <div class="te-latest-post-desc">
                    <span class="te-latest-post-meta">2025</span>
                    <h3 class="te-latest-post-title"><a href="gallery.html">بيت الربيان<br />Bait Al Robyan</a></h3>
                  </div>
                </li>
                <li>
                  <div class="te-latest-post-thumb"><a href="gallery.html"><img src="images/blog/r2.jpg" alt="Laguna Resort" /></a></div>
                  <div class="te-latest-post-desc">
                    <span class="te-latest-post-meta">2025</span>
                    <h3 class="te-latest-post-title"><a href="gallery.html">منتجع لاجونا<br />Laguna Resort</a></h3>
                  </div>
                </li>
              </ul>
            </div>
...
<div class="page-breadcrumb-area">
  <div class="page-bg">
    ...
    <img class="page-bg-image" src="" alt="page header" />
  </div>
  <div class="container">
    <div class="row">
      <div class="col-md-12">
...
(function ($) {
  ...
  $(document).ready(function () {
    ...
    if (!("loading" in HTMLImageElement.prototype)) {
      ...
      images.forEach((img) => {
        ...
        img.src =
          'data:image/svg+xml,%3Csvg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1 1"%3E%3C/svg%3E'; // Placeholder
  ...
  /*
        Preeloader - Optimized for faster loading
        ============================*/
  $(document).ready(function () {
    // Hide preloader after a short delay to ensure smooth UX
    // Wait for DOM to be ready, then hide after 1 second
    setTimeout(function () {
